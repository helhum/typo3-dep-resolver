...
namespace TYPO3\DependencyOrdering;
...
class DependencyOrderingService
{
     ...
     * @return array
     */
    public function orderByDependencies(array $items, $beforeKey = 'before', $afterKey = 'after'): array
    {
     ...
     */
    public function buildDependencyGraph(array $dependencies, $beforeKey = 'before', $afterKey = 'after'): array
    {
     ...
     * @return int
     */
    private function getIncomingEdgeCount(array $dependencyGraph, $identifier): int
    {
        $incomingEdgeCount = 0;
     ...
     */
    private function findPathInGraph(array $graph, $from, $to): array
    {
     ...
     */
    private function prepareDependencies(array $dependencies, $beforeKey = 'before', $afterKey = 'after'): array
    {
